            ...
            <section class="column width6 first"> 
                <div class="colgroup leading">
                   ...
                   <div class="column width3">
                       <fieldset>
                            <legend>评分</legend>
                            <form id="sampleform" action="updatetaskpf?taskid=${task.taskid }">
	                            <p>
	                                <label class="required" for="tasktitle">题目：</label><br/>
	                                <input type="text" id="tasktitle" class="full title" readonly="readonly" value="${task.title }" name="tasktitle"/>
	                            </p>
	                         
	                             <p>
	                                <label class="required" for="summary">简介：</label><br/>
	                                <textarea id="area2" class="medium full" readonly="readonly"  name="summary">${task.summary }</textarea>
	                            </p>
	                             <p>
	                                <label class="required" for="tasktitle">评价：</label><br/>
	                                <input type="text" id="tasktitle" class="full title"  value="" name="level"/>
	                            </p>
	                            <p>
	                                <input type="submit" class="btn btn-green big" value="评价"/>
	                                 or 
